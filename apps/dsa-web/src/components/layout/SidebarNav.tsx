...
import { Award, Activity, BarChart3, Bell, BriefcaseBusiness, FileText, Gauge, Home, LogOut, MessageSquareQuote, Network, Search, Settings2, ShieldAlert, TrendingUp } from 'lucide-react';
