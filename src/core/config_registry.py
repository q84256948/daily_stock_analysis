...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "SCHEDULE_LOCK_TIMEOUT": {
        "title": "Schedule Lock Timeout",
        "description": "Maximum seconds a scheduled task lock can be held before auto-expiry (default 7200 = 2h).",
        "category": "system",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
        ...
        "display_order": 13,
        "help_key": "settings.system.SCHEDULE_LOCK_TIMEOUT",
        "examples": [
            "SCHEDULE_LOCK_TIMEOUT=7200",
            "SCHEDULE_LOCK_TIMEOUT=3600",
        ],
        "docs": [],
        "warning_codes": [],
    },
    "SCHEDULE_ALERT_ENABLED": {
        "title": "Schedule Alert Enabled",
        "description": "Send notification when a scheduled task fails.",
        "category": "system",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
        ...
        "validation": {},
        "display_order": 14,
        "help_key": "settings.system.SCHEDULE_ALERT_ENABLED",
        "examples": [
    ...
    "SCHEDULE_ALERT_CHANNELS": {
        "title": "Schedule Alert Channels",
        "description": "Notification channels for schedule failure alerts (comma-separated: wechat/email/lark/dingtalk).",
        "category": "system",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        ...
        "validation": {},
        "display_order": 15,
        "help_key": "settings.system.SCHEDULE_ALERT_CHANNELS",
        "examples": [
            "SCHEDULE_ALERT_CHANNELS=wechat",
            "SCHEDULE_ALERT_CHANNELS=wechat,email",
        ],
        "docs": [],
        "warning_codes": [],
    },
